...
const Tyrannosaurus_D = new Tyrannosaurus({
    diet: 'carnivorous',
    weight: '7000kg',
    length: '12m',
...
const Stegosaurus_D = new Stegosaurus({
    diet: 'herbivorous',
    weight: '2000kg',
    length: '9m',
...
const Velociraptor_D = new Velociraptor({
    diet: 'carnivorous',
    weight: '15kg',
    length: '1.8m',
    period: 'Late Cretaceous'
...
const universities2 = graduates.sort(function(a, b) {
...
const unisWithUni = [];
for(var ii = 0; i < graduates.length; ii++){
  if(unisWithUni[ii].university.includes("Uni")){
    unisWithUni.push(unisWithUni[ii].university);
  }
}
...
const RunnerFilter = zooAnimals.filter(function(item){
